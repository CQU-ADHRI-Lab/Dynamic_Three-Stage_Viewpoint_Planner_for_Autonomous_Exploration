...
public:
  ...
  geometry_msgs::Point repulsive_force_;
  ...
  void get_avoidance(bool avoidance);
  std::tuple<Eigen::MatrixXd, Eigen::Vector2d> create_Avoidance_Ellipse(const geometry_msgs::Point& robot_pos,
                                                            const geometry_msgs::Point& repulsive_force,
                                                            double short_axis_length);

  void get_repulsive_force(geometry_msgs::Point repulsive_force);
